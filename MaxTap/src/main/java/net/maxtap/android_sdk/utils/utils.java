...
//        impressionData.caption_english =json_ad_data.has(Config.AdParms.CAPTION_ENGLISH) ? json_ad_data.getString(Config.AdParms.CAPTION_ENGLISH):"null";
        ...
        impressionData.product_article_type = json_ad_data.has(Config.AdParms.ARTICLE_TYPE) ? json_ad_data.getString(Config.AdParms.ARTICLE_TYPE) : "null";
...
//        clickProperties.caption_english =json_ad_data.has(Config.AdParms.CAPTION_ENGLISH) ? json_ad_data.getString(Config.AdParms.CAPTION_ENGLISH):"null";
        ...
        clickProperties.product_article_type = json_ad_data.has(Config.AdParms.ARTICLE_TYPE) ? json_ad_data.getString(Config.AdParms.ARTICLE_TYPE) : "null";
